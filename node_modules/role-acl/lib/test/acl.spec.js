...
describe('Test Suite: Access Control', function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ac.extendRole('admin', 'user')];
                    case 1:
                        _g.sent();
                        ac.grant('admin').execute('*').on('category');
                        return [4 /*yield*/, ac.extendRole('owner', 'admin')];
                    case 2:
                        _g.sent();
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        ac.grant('user').execute('*').on('image');
                        return [4 /*yield*/, ac.extendRole('sports/editor', 'user')];
                    case 1:
                        _j.sent();
                        return [4 /*yield*/, ac.extendRole('admin', 'user')];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ac.extendRole('onur', 'admin')];
                    case 1:
                        _a.sent();
                        expect(ac.getGrants().onur.$extend['admin']).toEqual({ condition: undefined });
                        ac.grant('role2, role3, editor, viewer, agent').execute('create').on('book');
                        return [4 /*yield*/, ac.extendRole('onur', ['role2', 'role3'])];
                    case 2:
                        _a.sent();
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, promiseThrowsError(ac.grant('roleX').extend('roleX'))];
                    case 6:
                        _a.sent();
                        return [4 /*yield*/, promiseThrowsError(ac.grant(['admin2', 'roleX']).extend(['roleX', 'admin3']))];
                    case 7:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ac.extendRole('editor', 'user')];
                    case 1:
                        _a.sent();
                        ac.grant('editor').execute('delete').on('book');
                        return [4 /*yield*/, promiseThrowsError(ac.extendRole('user', 'editor'))];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, promiseThrowsError(ac.extendRole('user', 'user'))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('should throw error while trying extend own role synchronously', function () {
        ...
        ac.grant('editor').execute('delete').on('book');
        throwsError(function () { return ac.extendRoleSync('user', 'editor'); });
        throwsError(function () { return ac.extendRoleSync('user', 'user'); });
    });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ac.extendRole('editor', ['sports/editor', 'politics/editor'])];
                    case 1:
                        _c.sent();
                        _a = expect;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ac.extendRole('sports/editor', 'editor', categorySportsCondition)];
                    case 1:
                        _f.sent();
                        return [4 /*yield*/, ac.extendRole('politics/editor', 'editor', categoryPoliticsCondition)];
                    case 2:
                        _f.sent();
                        _a = expect;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, ac.extendRole('sports-and-politics/editor', ['sports/editor', 'politics/editor'])];
                    case 3:
                        // second level of extension
                        _f.sent();
                        _a = expect;
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, ac.extendRole('conditonal/sports-and-politics/editor', 'sports-and-politics/editor', {
                                Fn: 'EQUALS',
                                args: { status: 'draft' }
                            })];
                    case 6:
